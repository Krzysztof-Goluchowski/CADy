...
function bitmap_h_red(filename,elementsx,elementsy,maxerror,max_refinement_level,color_edges_black)
...
RR = zeros(size(BB)); %Red color [0,255]
GG = zeros(size(BB)); %Green color [0,255]
